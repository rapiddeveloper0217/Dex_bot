...
async function getPairContract(factoryAddress, tokenAAddress, tokenBAddress) {
    var pairAddress;
    if(factoryAddress == '0xc6366EFD0AF1d09171fe0EBF32c7943BB310832a') {
        var factory = await ethers.getContractAt('@uniswap/v2-core/contracts/interfaces/IHoopsV2Factory.sol:IHoopsV2Factory', factoryAddress)
        pairAddress = await factory.getPair(tokenAAddress, tokenBAddress, 0)
    }
    else {
